...
# Add any additional .c files to MSRCS and .h files to MHDRS. Add multi-lookup.h and multi-lookup.c back when needed
MSRCS = multi-lookup.c array.c #multi-lookupPoison.c #test.c
